...
import { idlFactory } from './icticket.did.js';
export { idlFactory } from './icticket.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICTICKET_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icticket.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icticket canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icticket.did.js")._SERVICE>}
 */
export const icticket = createActor(canisterId);
